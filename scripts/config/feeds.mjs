export const FEEDS = [
  ...
  { name: 'Python Insider', url: 'https://blog.python.org/feeds/posts/default', category: '프로그래밍 언어', tags: ['Python'], allowedCategories: ['releases', 'security', 'performance'] },
  ...
  { name: '.NET Blog', url: 'https://devblogs.microsoft.com/dotnet/feed/', category: '프로그래밍 언어', tags: ['C#', '.NET'], allowedCategories: ['Featured', 'announcement', 'Security', 'Maintenance & Updates'] },
  { name: 'Swift Blog', url: 'https://www.swift.org/atom.xml', category: '프로그래밍 언어', tags: ['Swift', 'Apple'] },
  { name: 'Flutter Blog', url: 'https://medium.com/feed/flutter', category: '프로그래밍 언어', tags: ['Flutter', 'Dart'], allowedCategories: ['announcements'] },
  { name: 'Kotlin Blog', url: 'https://blog.jetbrains.com/kotlin/feed/', category: '프로그래밍 언어', tags: ['Kotlin', 'Android'], allowedCategories: ['releases', 'news'] },
  ...
  { name: 'Angular Blog', url: 'https://blog.angular.dev/feed', category: '프론트엔드', tags: ['Angular'], allowedCategories: ['angular-release', 'angular-security-update'] },
  ...
  { name: 'ASP.NET Core', url: 'https://devblogs.microsoft.com/dotnet/category/aspnet/feed/', category: '백엔드', tags: ['ASP.NET', 'C#', '.NET'], allowedCategories: ['announcement', 'Performance'] },
  { name: 'Laravel News', url: 'https://laravel-news.com/feed', category: '백엔드', tags: ['Laravel', 'PHP'], allowedCategories: ['News'] },
  ...
  { name: 'MySQL Blog (Percona)', url: 'https://www.percona.com/blog/feed/', category: '데이터베이스', tags: ['MySQL', 'Database'], allowedCategories: ['Release Notes', 'Database security', 'Open Source'] },
  { name: 'MongoDB Blog', url: 'https://www.mongodb.com/blog/rss', category: '데이터베이스', tags: ['MongoDB', 'NoSQL'] },
  { name: 'Redis Blog', url: 'https://redis.io/feed', category: '데이터베이스', tags: ['Redis', 'NoSQL', 'Cache'], allowedCategories: ['Announcements', 'Tech'] },
  ...
  // 5. 클라우드 & 인프라
  { name: 'AWS News Blog', url: 'https://aws.amazon.com/blogs/aws/feed/', category: '클라우드 & 인프라', tags: ['AWS', 'Cloud'], allowedCategories: ['Launch', 'News', 'Announcements'] },
  { name: 'Google Cloud Blog', url: 'https://cloudblog.withgoogle.com/rss/', category: '클라우드 & 인프라', tags: ['GCP', 'Cloud'] },
  { name: 'Docker Blog', url: 'https://www.docker.com/blog/feed/', category: '클라우드 & 인프라', tags: ['Docker', 'Infra'], allowedCategories: ['Products', 'Concepts', 'Security'] },
  ...
  { name: 'GitHub Changelog', url: 'https://github.blog/changelog/feed/', category: '클라우드 & 인프라', tags: ['GitHub', 'DevOps'], allowedCategories: ['Release', 'Improvement'] },

  // 6. 인공지능
  { name: 'Google DeepMind', url: 'https://deepmind.google/blog/rss.xml', category: '인공지능', tags: ['DeepMind', 'Gemini', 'AI'] },
  { name: 'Google Gemini Blog', url: 'https://blog.google/products-and-platforms/products/gemini/rss/', category: '인공지능', tags: ['Google', 'Gemini', 'AI'], allowedCategories: ['Gemini Features', 'Gemini models', 'AI Products'] },
  { name: 'OpenAI News', url: 'https://openai.com/news/rss.xml', category: '인공지능', tags: ['OpenAI', 'LLM', 'AI'], allowedCategories: ['Product', 'Research', 'Release'] },
  ...
  { name: 'WebKit Blog', url: 'https://webkit.org/blog/feed/', category: '웹 생태계 & 브라우저', tags: ['WebKit', 'Safari'], allowedCategories: ['News'] },
  { name: 'MDN Web Docs (Hacks)', url: 'https://hacks.mozilla.org/feed/', category: '웹 생태계 & 브라우저', tags: ['MDN', 'Web Standards'], allowedCategories: ['Firefox Releases', 'Featured Article'] },
